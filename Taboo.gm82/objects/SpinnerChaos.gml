...
for (i=0;i<num;i+=1) {
    o[i]=instance_create(x,y,QueenHead)
    o[i].depth=depth
...
o[0].sprite_index=sprQueenRed; o[0].att="red";
o[1].sprite_index=sprQueenYellow; o[1].att="yellow";
o[2].sprite_index=sprQueenBlue; o[2].att="blue";
o[3].sprite_index=sprQueenGreen; o[3].att="green";
