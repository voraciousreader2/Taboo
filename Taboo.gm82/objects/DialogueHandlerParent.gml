...
*/
//progress dialogue
if (key_shoot(vi_pressed) && messageIndex >= 0 && messageIndex <= totalMessages) {
...
//skip dialogue
if (key_skip(vi_pressed) && skippable && messageIndex >= 0){
    event_user(0)
}
#define Other_10
/*"/*'/**//* YYD ACTION
...
//play end music
if(endMusic != ""){
    sound_play_music(endMusic, loopEndMusic)
}
...
if( messageIndex >= 0 && totalMessages > 0 && messageIndex < totalMessages){
    ...
    //play start music
    if(startMusic != ""){
        sound_play_music(startMusic, loopStartMusic)
    }
