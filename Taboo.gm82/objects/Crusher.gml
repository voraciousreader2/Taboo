...
{
//col_x=collision_line(x,y,Player.x,y,Block,true,true) && collision_line(x,y,Player.x,y,Crusher,true,true) && collision_line(x,y,Player.x,y,CrusherK,true,true)
